...
## Licence
Both the mathlib library and this website are distributed under open-source licences: the [Apache 2.0](https://github.com/leanprover-community/mathlib4/blob/master/LICENSE) for mathlib and the [MIT licence](https://github.com/leanprover-community/mathlib-landing/blob/main/LICENSE) for this website. 
